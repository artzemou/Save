...
function Server(compiler, options) {
  ...
  app.post('/mailto', function (req, res) {
    /* Notre code pour nodemailer */
      var transporter = nodemailer.createTransport('smtps://sendnodemail@gmail.com:123PetitsP@s@smtp.gmail.com');
      console.log(req.body)
      var mailOptions = {
        //req.body.sender
          from: req.body.sender,
          to:'bfdlmdr@gmail.com',
      ...
      transporter.sendMail(mailOptions, function (error, info) {
          ...
          //res.send('Le mail a bien été envoyé');
  ...
  /*redirection envoi mail*/
  app.get('/redirect', (req, res) =>{
    res.setHeader('Content-Type', 'text/html');
    /* eslint-disable quotes */
    res.write('<!DOCTYPE html><html><head><meta charset="utf-8"/></head><body>');
    res.write('Le mail a bien été envoyé');
    res.end('<script>setTimeout(function(){window.location ="/"},3000)</script></body></html>');
  });
  /*************************************************************************************************/
